...
@keyframes wwPlayActiveSignal {
  0%, 100% {
    box-shadow:
      0 0 0 1px rgba(235,248,255,0.48),
      0 0 18px rgba(220,240,255,0.26),
      0 0 42px rgba(190,225,255,0.14);
  }

  50% {
    box-shadow:
      0 0 0 2px rgba(255,255,255,0.62),
      0 0 26px rgba(230,245,255,0.38),
      0 0 58px rgba(200,230,255,0.22);
  }
}
